...
public class AqeHomePageTest {
    ...
    public void init() {
        ...
        AqeHomePage aqeHomePage = new AqeHomePage(properties, requestBuilder, new ResponseParser(), metricsList);
        aqeHomePage.requestMetrics();
    ...
    public void validateRequiredMetrics() {
        //The duplicated warning occurs due to same metrics of AqeBlog and AqeHomepage
    ...
    public void validateHostname() {
        ...
        //Since hostname 'novatec-gmbh.de' is root, it is set implicitly and don't have to be set by a dimension filter
        assertThat(optionalDimensionFilter).isEqualTo(Optional.empty());
    }

    @Test
    public void validateExcludedUrls() {
        List<String> expectedExcludedUrls = new ArrayList<>();
