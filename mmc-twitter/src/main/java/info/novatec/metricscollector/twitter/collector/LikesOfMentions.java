...
@Component
public class LikesOfMentions extends TwitterBasicMetricCollector implements TwitterMetricCollector {
    public LikesOfMentions(Twitter twitter, Metrics metrics) {
